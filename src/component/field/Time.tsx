    ...
    return (
        <div className="field">
            ...
            <div className="field__inputs field__inputs--time">
                ...
                <label>
                    <input type="number" maxLength={2} max="60" min="-1" placeholder="0" value={time.m} data-category="time" data-unit="m" onFocus={handleFocus} onChange={handleChange} onKeyDown={handleKeyDown} />
                    <span>分</span>
                </label>
                <label>
                    <input type="number" maxLength={2} max="60" min="-1" placeholder="0" value={time.s} data-category="time" data-unit="s" onFocus={handleFocus} onChange={handleChange} onKeyDown={handleKeyDown} />
                    <span>秒</span>
                </label>
            </div>
        </div>
